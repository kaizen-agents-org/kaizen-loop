...
- `guardian.command` runs the vendored `pr-guardian` workflow after PR creation; unresolved, non-outdated review threads keep the guardian loop running up to `guardian.maxAttempts`.
