...
1. Identify the PR number, repository, branch, remote, base branch, and current head SHA. Generated sync PRs carrying `<!-- kaizen-pr-guardian:managed -->` are adopted by scheduled reconciliation.
