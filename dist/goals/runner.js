...
async function captureGoalStateIdentity(projectPath, goalPath) {
    return {
...
async function assertGoalStateIdentity(identity, lock) {
...
async function assertDirectoryIdentity(identity) {
    const stats = await fs.lstat(identity.path).catch((error) => {
